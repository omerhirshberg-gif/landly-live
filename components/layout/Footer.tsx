      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between gap-10 mb-10 sm:mb-12">
          <div className="max-w-xs">
            ...
            <p className="text-xs mt-3">contact@landly.io · <span>{t('footer_location')}</span></p>
            ...
            <div className="mt-5">
              ...
              <div className="flex items-center gap-2.5">
                <a href="#" aria-label="Instagram" className="tap-target w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition">
                  <i className="fa-brands fa-instagram text-white text-base"></i>
                </a>
                <a href="#" aria-label="Facebook" className="tap-target w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/login" className="hover:text-white transition">{t('nav_perks')}</Link></li>
              </ul>
            </div>
            <div>
        ...
        <div className="border-t border-slate-800 pt-6 text-xs text-center">© 2025 Landly · <span>{t('footer_location')}</span> · <span>{t('footer_copyright_suffix')}</span> · <span>{t('footer_copyright_notice')}</span></div>
      </div>
    </footer>
  )
}
